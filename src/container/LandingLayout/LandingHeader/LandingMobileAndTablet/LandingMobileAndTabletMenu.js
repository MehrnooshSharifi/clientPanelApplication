...
const LandingMobileAndTabletMenu = ({ isOpen, setIsOpen, link }) => {
  ...
  return (
    <div>
      ...
      >
        <div
          className={` flex flex-col items-start w-[323px] -mr-7 overflow-y-auto overflow-x-clip  h-[812px] bg-naturalColor-2 shadow-2xl rounded-tl-[50px] rounded-bl-[50px] pt-7 pr-4 md:w-[375px] md:h-screen `}
        >
          {/*Close Icon */}
          <MdOutlineClose
            className="w-[30.85px] h-[30.85px] mb-[55px]  cursor-pointer absolute"
          ...
          <nav className="m-[16px] ">
            <ul className="flex flex-col gap-y-10 items-start text-[14px] font-[15px] md:text-[16px]">
              ...
              <div className={`flex flex-col justify-center w-full`}>
                ...
                {isSelected && (
                  <ul
                    className={`text-[12px] md:text-[14px] -mr-[13px]  ${
                      isSelected &&
              ...
              <div className="flex items-center mb-10 ">
                <BiAward className="w-[30px] h-[30px] -mr-2 fill-neutralColor-1" />
                <li>
                  <Link href="/termsAndConditions">
                    <span className="p-10 -mr-5">قوانین و مقررات</span>
                  </Link>
                </li>
              </div>
              <div className="flex items-center mb-10 ">
      ...
      <div
        className={`z-40 ${
          isOpen &&
          " fixed top-0 -mr-[25px]   w-[1500px] h-[1024px]  backdrop-brightness-50 backdrop-contrast-100  backdrop-opacity-80 lg:backdrop-opacity-0 "
        }`}
        onClick={() => setIsOpen(false)}
      ></div>
    </div>
...
export default LandingMobileAndTabletMenu;
