...
const LandingFooter = ({ link }) => {
  const router = useRouter();
  return (
    <div className="flex flex-col bottom-0 left-0 right-0" id={link[0].id}>
      {/* FooterInfo */}
          ...
          <div className="flex mx-auto items-center mb-[20px] md:mb-0 md:flex-col md:items-start md:mr-10 lg:mr-[155px]">
            ...
            >
              <Image
                width={100}
                height={100}
                className="w-[34px] h-[34px] md:w-[50.2px] md:h-[50px] lg:w-[70px] lg:h-[70px]  "
