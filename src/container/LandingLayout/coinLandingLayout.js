...
import LandingFooter from "../LandingLayout/LandingFooter/LandingFooter";
import LandingDesktopHeader from "../LandingLayout/LandingHeader/Desktop/LandingDesktopHeader";
import LandingMobileAndTabletHeader from "../LandingLayout/LandingHeader/LandingMobileAndTablet/LandingMobileAndTabletHeader";
...
const CoinLandingLayout = ({ children }) => {
    ...
    <div className="flex flex-col bg-neutralColor-5">
      <div className="bg-primaryColor-1 w-full h-[650px]  md:h-[750px] lg:h-[650px] pt-[48px] lg:pt-[78px] -mt-10 lg:-mt-20 rounded-bl-[25px] rounded-br-[25px] lg:rounded-bl-[100px] lg:rounded-br-[100px]  mb-[55px] md:mb-[67.5px] lg:mb-[132px]">
        <div className="lg:relative lg:max-w-[1440px] lg:mx-auto">
          <div className="mb-[55px] mx-6">
            <LandingMobileAndTabletHeader
              link={link}
              className2="w-[20px] h-[20px] md:w-[40px] md:h-[40px] cursor-pointer text-naturalColor-2"
          ...
          {/* Service Details */}
          <div className="flex flex-col lg:flex-row lg:max-w-[1440px] lg:mx-auto lg:-mt-[90px]">
            {/* serviceDescription */}
            <div className="flex flex-col items-center justify-center gap-y-[29px] lg:items-start lg:mr-[40px]">
              ...
              <TextDirectionWrapper className="w-[335px] h-[175px] mx-auto md:w-[648px] md:[175px] lg:w-[847px] lg:h-[175px]">
                <span className="text-naturalColor-2  text-[14px] font-medium leading-[35px] w-[335px] h-[175px] mx-auto md:w-[648px] md:[175px] md:text-[16px] md:font-medium md:leading-[45px] lg:w-[847px] lg:h-[175px] lg:leading-[60px] lg:text-[24px] lg:font-medium">
                  {t("coinLandingLayout.description")}
                </span>
              </TextDirectionWrapper>
            </div>
            {/* serviceImage */}
            <div className="flex flex-col items-center justify-center lg:mt-28 lg:mr-10">
              <Image
                ...
                alt="plusGroup"
                className="w-[206.64px] h-[122.28px] md:w-[700px] md:h-[265.52px] z-10 md:-mt-26"
              />
              <Image
                width={20}
                height={20}
                src="/assets/images/NewHomePage/coinLanding.svg"
                alt="coin"
                className="w-[67px] h-[165px] -mt-[90px] md:w-[77.15px] md:h-[190px]  md:-mt-[230px] z-10 lg:w-[121.69px] lg:h-[300px] lg:-mt-[200px] "
              />
              <Image
                alt="blueSemiCircle"
                width={20}
                ...
                className="z-0 -mt-[209px] md:-mt-[309px] w-[330px] h-[330px] md:w-[505px] md:h-[505px] lg:hidden"
              />
            </div>
          </div>
          {/* dotCorner */}
          <div className="hidden lg:block lg:max-w-[500px] mx-auto lg:absolute right-[40px] top-[470px]">
            <Image
              width={20}
              height={20}
              alt="dotCorner"
          ...
          <div className="bg-naturalColor-2  w-[82.93px] h-[40px] mx-auto  md:w-[103.66px] md:h-[50px] -mt-[95px] md:-mt-[140px] lg:w-[165.86px] lg:h-[60px] lg:mt-[45px] animate-twBounce animate-infinite animate-duration-[3s] flex items-center justify-center text-primaryColor-1 rounded-[25px]">
...
export default CoinLandingLayout;
