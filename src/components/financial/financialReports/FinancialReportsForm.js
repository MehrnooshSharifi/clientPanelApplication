...
import { FinancialReport } from "@/server/Service";
...
const FinancialReportsForm = () => {
  ...
  const submitHandler = async (event) => {
    ...
    setIsLoading(true);
    const res = await FinancialReport(dateObject, nationalCode);
    if (res.data) {
  ...
  return (
    <>
      <div
        className={` h-[500px]  lg:w-[1024px] flex flex-col gap-y-[20px] lg:mr-[25px] ${
...
export default FinancialReportsForm;
